...
train_paths = ['C:/Users/admin/Desktop/dataset/UCI HAR Dataset/UCI HAR Dataset/train/Inertial Signals/' + signal + 'train.txt' for signal in SIGNALS]
test_paths = ['C:/Users/admin/Desktop/dataset/UCI HAR Dataset/UCI HAR Dataset/test/Inertial Signals/' + signal + 'test.txt' for signal in SIGNALS]
...
y_train = np.loadtxt('C:/Users/admin/Desktop/dataset/UCI HAR Dataset/UCI HAR Dataset/train/y_train.txt',  dtype=np.int32)
y_test = np.loadtxt('C:/Users/admin/Desktop/dataset/UCI HAR Dataset/UCI HAR Dataset/test/y_test.txt', dtype=np.int32)
